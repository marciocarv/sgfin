...
<div class="block w-full mt-24">
  ...
  <div class="">
    <h1 class="mt-5 text-2xl font-bold"><i class="fas fa-graduation-cap"></i> Dados da Escola <span class="text-xs"><a href="{{route('upSchool', ['id'=>$school->id])}}" class="text-blue-700"><i class="fas fa-edit"></i> Editar Escola</a></span></h1>
  </div>
  <div class="relative flex flex-col min-w-0 break-words bg-white rounded mt-8 xl:mb-0 shadow-lg">
    ...
    <div class="">
      <h1 class="mt-5 text-2xl font-bold"><i class="fas fa-users"></i> ACE <span class="text-xs"><a href="{{route('upSchool', ['id'=>$school->id])}}" class="text-blue-700"><i class="fas fa-edit"></i> Editar ACE</a></span></h1>
    </div>
  @if($school->ace)
    <div class="relative flex flex-col min-w-0 break-words bg-white rounded mt-8 xl:mb-0 shadow-lg">
