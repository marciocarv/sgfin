...
<div class="block w-full mt-24">
  <a href="{{route('addProvider')}}" class="p-3 bg-gray-800 text-white rounded hover:bg-gray-700"><i class="fas fa-plus"></i> Adicionar Fornecedor</a>
<div class="">
    <h1 class="mt-5 text-2xl text-center font-bold"><i class="fas fa-file-contract"></i> Fornecedores (Produtos e serviços)</h1>
</div>
@if (session('msg'))
    <p class="bg-green-300 p-4 font-bold leading-normal mb-3 mt-3 rounded-lg text-green-800">{{ session('msg') }}</p>
@endif
<div class="rounded border shadow py-3">
